...
function game:update()
	...
	for i in all(self.items) do i:update() end
...
function game:draw()
	...
	if self.cur_area.id == 9 then
		...
		sspr(0,98,tw,th,8*1.5,0)
		pal(7,1)
	elseif self.cur_area.id == 6 then
		-- draw catsle sign
		local x,y=79*8+1,7*8-1
		door.draw_sign(82*8+4,y,6*8+2,2*8-4)
		local tw, th=45,10
		pal(7,14)
		-- this ridiculousness is to make a small-case c
		sspr(78,101,tw-8,th,x+13,y+4)
		sspr(70,103,tw,th,x+5,y+6)
...
function door:draw()
	...
	if(self.label) do
		...
		local bb = self:bb()
		self.draw_sign(bb.cx, bb.n, width)
		print(self.label,bb.cx-flr(width/2)+self.label_offset,bb.n+4,5)
	end
end
function door.draw_sign(centerx, top, width, height)
	if(not height) height=8
	local halfw = max(width/2, 2*4)
	rectfill(
		centerx-flr(halfw)-2,top+2,
		centerx+ceil(halfw),top+2+height,15
	)
	rect(
		centerx-flr(halfw)-2,top+2,
		centerx+ceil(halfw)+1,top+2+height,4
	)
end
...

...

...

...

__map__
...

...

...

