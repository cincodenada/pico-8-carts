...
function draw_palette()
	...
	local tot_w=numhues*size+4*4+2
	-- 2 lines top/bottom
	-- plus 1px padding/side
	local tot_h=numvals*size+4*6+2
	...
	local offy=top + tot_h/2 - (numvals*size/2)
		...
		for x=-1,1 do
			for y=-1,1 do
				if (abs(x+y)==1) then
					...
					local func = get_func(curhv, cmphv)
					local revfunc = get_func(cmphv, curhv)
					if(x==0) then
						rely = offy+(numvals*size-5)*(y+1)/2
						nudgey = 6*y
						print(func,128/2-#func*2,rely+nudgey*2,7)
						print(revfunc,128/2-#revfunc*2,rely+nudgey,7)
					else
						relx=offx+(numvals*size+5)*(x+1)/2
						nudgex = 4*x
						posy=offy+9-#func*3
						for c=1,#func do
							print(sub(func,c,c),relx+nudgex*2,posy+(c-1)*6,7)
						end
						posy=offy+9-#revfunc*3
						for c=1,#revfunc do
...
__gfx__

...

...

...
__gff__

